...
const DomainSettings = ({ onViewChange }) => {
  const mockDomains = [
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{mockDomains.reduce((sum, d) => sum + d.links, 0)}</p>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <tr key={domain.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                        domain.type === 'system' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'
                      }`}>
                        {domain.type}
                      </span>
                    </td>
